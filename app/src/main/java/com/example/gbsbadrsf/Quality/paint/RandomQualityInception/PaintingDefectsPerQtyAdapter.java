...
public class PaintingDefectsPerQtyAdapter extends RecyclerView.Adapter<PaintingDefectsPerQtyAdapter.ManufacturingDefectsViewHolder> {
    ...
    public PaintingDefectsPerQtyAdapter(Context context, SetOnDefectsPerQtyItemClicked onItemClicked, SetOnDeleteButtonClicked onDeleteButtonClicked) {
    ...
    public interface SetOnDeleteButtonClicked{
        void onDeleteButtonClicked(int manufacturingDefectId,int groupId,int listSize);
    }
}
