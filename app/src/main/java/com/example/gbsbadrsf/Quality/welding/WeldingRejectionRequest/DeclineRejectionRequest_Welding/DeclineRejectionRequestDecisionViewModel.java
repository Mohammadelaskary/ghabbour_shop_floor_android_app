...
public class DeclineRejectionRequestDecisionViewModel extends AndroidViewModel {
    ...
    MutableLiveData<ApiResponseWeldingRejectionRequestCloseDeclinedRequest> saveCommitteeDecision;
//    @Inject
...
//    @Inject
    ...
    public void setSaveCommitteeDecision(
            ...
            String Notes){
        disposable.add(apiInterface.saveCommitteeDecision_Welding(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNo,rejectionRequestId,OkQty,OkBasketCode,RejectedQty,DepartmentId,RejectionReasonID,Notes)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnSubscribe( __ -> status.postValue(Status.LOADING))
                .subscribe(
    ...
    public MutableLiveData<ApiResponseWeldingRejectionRequestCloseDeclinedRequest> getSaveCommitteeDecision() {
