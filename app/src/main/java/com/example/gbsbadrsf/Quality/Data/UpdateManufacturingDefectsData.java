...
public class UpdateManufacturingDefectsData {
    ...
    public UpdateManufacturingDefectsData(Integer userId, String deviceSerialNo, Integer mainDefectsId, Integer defectGroupId, Integer qtyDefected, List<Integer> defectList, Boolean isBulkGroup, Boolean isRejected, String appLang) {
        this.userId = userId;
