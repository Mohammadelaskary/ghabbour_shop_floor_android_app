...
public class WeldingDefectsListAdapter extends RecyclerView.Adapter<WeldingDefectsListAdapter.DefectViewHolder> {
    List<Defect> defects;
    List<Integer> selectedDefectsIds = new ArrayList<>();
    Context context;
    SetOnItemClicked onItemClicked;

    public WeldingDefectsListAdapter(Context context, SetOnItemClicked onItemClicked) {
    ...
    public void onBindViewHolder(@NonNull DefectViewHolder holder, int position) {
        ...
        else holder.binding.defectName.setText(defect.getArName());
