...
//        viewModel = ViewModelProviders.of(this,provider).get(WeldingRejectionRequestDetailsViewModel.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        observeGetRejectionRequestById();
        setUpDefectsBottomSheet();
    }
    private List<Defects> defectList = new ArrayList<>();
    private void observeGetRejectionRequestById() {
        viewModel.getRejectionRequestById.observe(getViewLifecycleOwner(),apiResponseWeldingRejectionRequestGetRejectionRequestByID -> {
            rejectionRequest = apiResponseWeldingRejectionRequestGetRejectionRequestByID.getRejectionRequest();
            defectList = apiResponseWeldingRejectionRequestGetRejectionRequestByID.getDefectsList();
        });
    }
