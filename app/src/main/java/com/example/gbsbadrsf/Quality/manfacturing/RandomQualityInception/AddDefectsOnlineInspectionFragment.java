...
import com.example.gbsbadrsf.databinding.FragmentAddDefectsOnlineInspectionBinding;
...
public class AddDefectsOnlineInspectionFragment extends Fragment implements SetOnManufacturingAddDefectDetailsButtonClicked, View.OnClickListener {
    ...
    private AddDefectsOnlineInspectionViewModel viewModel;

    public static AddDefectsOnlineInspectionFragment newInstance() {
        return new AddDefectsOnlineInspectionFragment();
    }
    private FragmentAddDefectsOnlineInspectionBinding binding;
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        binding = FragmentAddDefectsOnlineInspectionBinding.inflate(inflater,container,false);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this).get(AddDefectsOnlineInspectionViewModel.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        viewModel.getDefects(machineData.getOperationId());
    ...
    private void observeAddingDefects() {
        viewModel.getAddManufacturingDefectsResponse().observe(getViewLifecycleOwner(),apiResponseAddingManufacturingDefect_online -> {
    ...
    private void fillData() {
        binding.childParentDesc.setText(machineData.getChildDescription());
        binding.jobOrderData.jobordernum.setText(machineData.getJobOrderName());
        binding.jobOrderData.Joborderqtn.setText(String.valueOf(machineData.getJobOrderQty()));
...
//        adapter.setCheckedDefectsIds(selectedDefectsIds);
    ...
    private LastMoveManufacturingMachineOnline machineData;
    private String sampleQty;
    private List<DefectsPerQty> defects;
    private int groupId,defectedQty,remainingQty,mainDefectsId,productionSequenceNo;
    ...
    private void getReceivedData() {
        if (getArguments()!=null) {
            ...
            remainingQty = machineData.getSignOffQty()+defectedQty-Integer.parseInt(machineData.getTotalQtyDefected())-Integer.parseInt(machineData.getTotalQtyRejected());
        }
    }
                    ...
                    if (containsOnlyDigits(defectedQtyString)){
                        ...
                        if (validDefectedQty) {
                            if (!selectedDefectsIds.isEmpty()) {
                                if (!isUpdate) {
                                    AddManufacturingDefectData_Online data = new AddManufacturingDefectData_Online(
                                            USER_ID,
                                            DEVICE_SERIAL_NO,
                                            machineData.getJobOrderId(),
                                            machineData.getParentId(),
                                            machineData.getChildId(),
                                            machineData.getOperationId(),
                                            defectedQty,
                                            machineData.getMachineCode(),
                                    ...
                                    UpdateManufacturingDefectsData_Online data = new UpdateManufacturingDefectsData_Online(
                                            USER_ID,
                                            DEVICE_SERIAL_NO,
                                            defectedQty,
                                            groupId,
