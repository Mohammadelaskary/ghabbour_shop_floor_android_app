...
//    @Inject
    ...
    MutableLiveData<ApiResponsePaintingRejectionRequestCloseRequest> getCloseRejectionRequestResponse;
...
//    @Inject
    ...
    public void closeRejectionRequest(int userId,String deviceSerialNo,int rejectionRequestId,String certificateNo){
        disposable.add(apiInterface.PaintingRejectionRequestCloseRequest(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNo,rejectionRequestId,certificateNo)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnSubscribe( __ -> status.postValue(Status.LOADING))
                .subscribe(
    ...
    public MutableLiveData<ApiResponsePaintingRejectionRequestCloseRequest> getGetCloseRejectionRequestResponse() {
