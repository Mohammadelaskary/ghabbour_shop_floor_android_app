...
public class SaveRejectionRequestBody_Painting {
    ...
    public SaveRejectionRequestBody_Painting(Integer userId, String deviceSerialNo, String oldBasketCode, String newBasketCode,  Integer rejectionQty, Integer departmentID, Integer rejectionReasonID, List<Integer> defectList, String appLang) {
        this.userId = userId;
