...
public class UpdatePaintingDefectsData_Online {
    ...
    public UpdatePaintingDefectsData_Online(Integer userId, String deviceSerialNo, Integer qtyDefected, Integer defectGroupId, Integer mainDefectsId, List<Integer> defectList, Boolean isBulkGroup, Boolean isRejected, String appLang) {
        this.userId = userId;
