...
public class UpdateWeldingDefectsData_Online {
    ...
    public UpdateWeldingDefectsData_Online(Integer userId, String deviceSerialNo, Integer qtyDefected, Integer defectGroupId, Integer mainDefectsId, List<Integer> defectList, Boolean isRejected, String appLang) {
        this.userId = userId;
