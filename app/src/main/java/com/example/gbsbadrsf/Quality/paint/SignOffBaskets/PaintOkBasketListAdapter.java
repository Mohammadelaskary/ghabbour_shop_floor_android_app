...
public class PaintOkBasketListAdapter extends RecyclerView.Adapter<PaintOkBasketListAdapter.OkBasketListViewHolder> {
    public List<OkBasketLst> okBasketList;
    OnBasketRemoved onBasketRemoved;
    private boolean isBulk;
    public PaintOkBasketListAdapter(List<OkBasketLst> okBasketList, OnBasketRemoved onBasketRemoved, boolean isBulk) {
