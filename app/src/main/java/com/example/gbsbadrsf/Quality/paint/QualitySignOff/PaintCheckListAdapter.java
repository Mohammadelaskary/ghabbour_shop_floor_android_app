...
public class PaintCheckListAdapter extends RecyclerView.Adapter<PaintCheckListAdapter.CheckListViewHolder> {
    List<GetCheck> checkList;
    List<SaveCheckListResponse> savedCheckList;
    PaintSetOnCheckItemChecked setOnCheckItemChecked;

    public PaintCheckListAdapter(List<GetCheck> checkList, List<SaveCheckListResponse> savedCheckList, PaintSetOnCheckItemChecked setOnCheckItemChecked) {
