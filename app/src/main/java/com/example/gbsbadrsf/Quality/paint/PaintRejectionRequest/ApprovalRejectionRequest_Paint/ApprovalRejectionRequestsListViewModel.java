...
//    @Inject
    ...
    private MutableLiveData<ApiResponsePaintingRejectionRequestGetRejectionRequestList> getRejectionRequestListLiveData;
...
//    @Inject
    ...
    public void getRejectionRequests(int userId,String deviceSerialNo){
        disposable.add(apiInterface.getApprovalRejectionRequestsList_Painting(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNo)
    ...
    public MutableLiveData<ApiResponsePaintingRejectionRequestGetRejectionRequestList> getGetRejectionRequestListLiveData() {
