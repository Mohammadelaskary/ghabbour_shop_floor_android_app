...
//    @Inject
    ...
    private MutableLiveData<ApiResponseManufacturingRejectionRequestGetApprovedRejectionList> getRejectionRequestListLiveData;
...
//    @Inject
    ...
    public void getRejectionRequests(int userId,String deviceSerialNo){
        disposable.add(apiInterface.getApprovalRejectionRequestsList_Manufacturing(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNo)
    ...
    public MutableLiveData<ApiResponseManufacturingRejectionRequestGetApprovedRejectionList> getGetRejectionRequestListLiveData() {
