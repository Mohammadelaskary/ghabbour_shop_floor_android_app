...
public class FullInspectionData_Welding {
    ...
    public FullInspectionData_Welding(Integer userId, String deviceSerialNo, String basketCode, String defectedBasketCode, String rejectedBasketCode, List<OkBasketLst> okBasketLst, Boolean isBulkQty, String appLang) {
        this.userId = userId;
