...
public class WeldingQualityDecisionViewModel extends AndroidViewModel {
...
//    Gson gson;
//    @Inject
    public WeldingQualityDecisionViewModel(Application application) {
        super(application);
    ...
    public void getQualityOperationByBasketCode(int userId,String deviceSerialNumber,String basketCode){
        disposable.add(apiInterface.getWeldingDefectedQtyByBasketCode(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNumber,basketCode)
    ...
    public void getSavedCheckList(int userId,String deviceSerialNo,int childId,int jobOrderId,int operationId){
        disposable.add(apiInterface.getSavedCheckList_Welding(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNo,childId,jobOrderId,operationId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public void saveQualityOperationSignOff(int userId,String deviceSerialNumber,String basketCode,String date,int finalQualityDecisionId){
        disposable.add(apiInterface.QualityOperationSignOff_Welding(LocaleHelper.getLanguage(getApplication().getApplicationContext()),userId,deviceSerialNumber,basketCode,date,finalQualityDecisionId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
