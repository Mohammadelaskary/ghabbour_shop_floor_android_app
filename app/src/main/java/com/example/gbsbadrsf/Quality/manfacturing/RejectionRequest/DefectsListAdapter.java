...
public class DefectsListAdapter extends RecyclerView.Adapter<DefectsListAdapter.DefectViewHolder> {
    List<Defect> defects;
    List<Integer> selectedDefectsIds = new ArrayList<>();
    Context context;
    SetOnItemClicked onItemClicked;

    public DefectsListAdapter(Context context, SetOnItemClicked onItemClicked) {
    ...
    public interface SetOnItemClicked {
        void OnItemClicked(List<Integer> ids);
