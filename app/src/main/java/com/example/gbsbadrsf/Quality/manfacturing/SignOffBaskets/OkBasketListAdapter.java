...
public class OkBasketListAdapter extends RecyclerView.Adapter<OkBasketListAdapter.OkBasketListViewHolder> {
    public List<OkBasketLst> okBasketList;
    OnBasketRemoved onBasketRemoved;
    private boolean isBulk;
    public OkBasketListAdapter(List<OkBasketLst> okBasketList,OnBasketRemoved onBasketRemoved,boolean isBulk) {
