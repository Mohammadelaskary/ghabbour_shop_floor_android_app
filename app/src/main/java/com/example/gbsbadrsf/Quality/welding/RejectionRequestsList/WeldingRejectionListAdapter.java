...
public class WeldingRejectionListAdapter extends RecyclerView.Adapter<WeldingRejectionListAdapter.ProductionRejectionListViewHolder> {
    ProductionscrapLstBinding binding;
    List<RejectionRequest> rejectionRequests;


    public WeldingRejectionListAdapter() {
    }
    ...
    public void onBindViewHolder(@NonNull ProductionRejectionListViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            Navigation.findNavController(view).navigate(R.id.action_fragment_welding_rejection_requests_list_to_fragment_welding_rejection_request_details,bundle);
        });
    }
