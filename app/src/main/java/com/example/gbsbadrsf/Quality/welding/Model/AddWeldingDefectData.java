...
public class AddWeldingDefectData {
    ...
    public AddWeldingDefectData(int userId, String deviceSerialNo, int jobOrderId, int parentID, int childId, int operationID, int qtyDefected, String notes, int sampleQty, List<Integer> defectList, String basketCode, boolean isRejected, boolean isBulkGroup, boolean isSaved, String appLang) {
        UserId = userId;
