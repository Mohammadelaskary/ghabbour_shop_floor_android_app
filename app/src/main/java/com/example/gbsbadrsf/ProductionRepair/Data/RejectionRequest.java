...
public class RejectionRequest {
    ...
    @SerializedName("declineNotes")
    @Expose
    private Object declineNotes;
    @SerializedName("declinedUserId")
    @Expose
    private Object declinedUserId;
    @SerializedName("declinedDate")
    @Expose
    private Object declinedDate;
    @SerializedName("declinedApprovedOkQty")
    @Expose
    private Integer declinedApprovedOkQty;
    @SerializedName("declinedOkBasket")
    @Expose
    private Object declinedOkBasket;
    @SerializedName("declinedApprovedRejectedQty")
    @Expose
    private Integer declinedApprovedRejectedQty;
    @SerializedName("otherDepartmentIsApprove")
    @Expose
    private Object otherDepartmentIsApprove;
    @SerializedName("otherDepartmentTakeActionUserId")
    @Expose
    private Object otherDepartmentTakeActionUserId;
    @SerializedName("otherDepartmentTakeActionDate")
    @Expose
    private Object otherDepartmentTakeActionDate;
    ...
    public Object getDeclineNotes() {
        return declineNotes;
    }

    public void setDeclineNotes(Object declineNotes) {
        this.declineNotes = declineNotes;
    }

    public Object getDeclinedUserId() {
        return declinedUserId;
    }

    public void setDeclinedUserId(Object declinedUserId) {
        this.declinedUserId = declinedUserId;
    }

    public Object getDeclinedDate() {
        return declinedDate;
    }

    public void setDeclinedDate(Object declinedDate) {
        this.declinedDate = declinedDate;
    }

    public Integer getDeclinedApprovedOkQty() {
        return declinedApprovedOkQty;
    }

    public void setDeclinedApprovedOkQty(Integer declinedApprovedOkQty) {
        this.declinedApprovedOkQty = declinedApprovedOkQty;
    }

    public Object getDeclinedOkBasket() {
        return declinedOkBasket;
    }

    public void setDeclinedOkBasket(Object declinedOkBasket) {
        this.declinedOkBasket = declinedOkBasket;
    }

    public Integer getDeclinedApprovedRejectedQty() {
        return declinedApprovedRejectedQty;
    }

    public void setDeclinedApprovedRejectedQty(Integer declinedApprovedRejectedQty) {
        this.declinedApprovedRejectedQty = declinedApprovedRejectedQty;
    }

    public Object getOtherDepartmentIsApprove() {
        return otherDepartmentIsApprove;
    }

    public void setOtherDepartmentIsApprove(Object otherDepartmentIsApprove) {
        this.otherDepartmentIsApprove = otherDepartmentIsApprove;
    }

    public Object getOtherDepartmentTakeActionUserId() {
        return otherDepartmentTakeActionUserId;
    }

    public void setOtherDepartmentTakeActionUserId(Object otherDepartmentTakeActionUserId) {
        this.otherDepartmentTakeActionUserId = otherDepartmentTakeActionUserId;
    }

    public Object getOtherDepartmentTakeActionDate() {
        return otherDepartmentTakeActionDate;
    }

    public void setOtherDepartmentTakeActionDate(Object otherDepartmentTakeActionDate) {
        this.otherDepartmentTakeActionDate = otherDepartmentTakeActionDate;
    }
