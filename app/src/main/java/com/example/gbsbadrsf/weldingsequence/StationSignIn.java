...
public class StationSignIn {
    ...
    public StationSignIn(int userID, String deviceSerialNo, int loadingSequenceID, String productionStationCode, int loadingQty, List<String> basketList, String appLang) {
        UserID = userID;
