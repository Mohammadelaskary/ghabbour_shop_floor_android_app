...
public class GetMachineLoadingData {
    ...
    @SerializedName("loadingManufacturingTransactionId")
    @Expose
    private Integer loadingManufacturingTransactionId;
    ...
    public Object getDieId() {
        return dieId;
    }

    public void setDieId(Object dieId) {
        this.dieId = dieId;
    }
    ...
    public Integer getLoadingManufacturingTransactionId() {
        return loadingManufacturingTransactionId;
    }

    public void setLoadingManufacturingTransactionId(Integer loadingManufacturingTransactionId) {
        this.loadingManufacturingTransactionId = loadingManufacturingTransactionId;
    }
