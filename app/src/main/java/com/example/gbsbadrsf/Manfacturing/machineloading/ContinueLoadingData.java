...
public class ContinueLoadingData {
    ...
    public ContinueLoadingData(Integer userID, String deviceSerialNo, String machineCode, String dieCode, Integer loadingQtyMobile, List<String> basketLst, String appLang) {
        this.userID = userID;
    ...
    public ContinueLoadingData(Integer userID, String deviceSerialNo, String machineCode, Integer loadingQtyMobile, List<String> basketLst, String appLang) {
        this.userID = userID;
        this.deviceSerialNo = deviceSerialNo;
        this.machineCode = machineCode;
        this.loadingQtyMobile = loadingQtyMobile;
