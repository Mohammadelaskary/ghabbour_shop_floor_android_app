...
public class PprWelding implements Parcelable {
    ...
    public static final Creator<PprWelding> CREATOR = new Creator<PprWelding>() {
        @Override
        public PprWelding createFromParcel(Parcel in) {
            return new PprWelding(in);
        }

        @Override
        public PprWelding[] newArray(int size) {
            return new PprWelding[size];
        }
    };
