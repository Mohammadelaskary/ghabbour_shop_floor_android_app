...
public class Pprpaint implements Parcelable {
    ...
    public static final Creator<Pprpaint> CREATOR = new Creator<Pprpaint>() {
        @Override
        public Pprpaint createFromParcel(Parcel in) {
            return new Pprpaint(in);
        }

        @Override
        public Pprpaint[] newArray(int size) {
            return new Pprpaint[size];
        }
    };
