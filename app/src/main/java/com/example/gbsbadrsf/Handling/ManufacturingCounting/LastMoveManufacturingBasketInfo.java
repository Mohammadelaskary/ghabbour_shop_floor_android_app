...
public class LastMoveManufacturingBasketInfo {
    ...
    @SerializedName("relatedBasketLst")
    @Expose
    private Object relatedBasketLst;
    ...
    public Object getRelatedBasketLst() {
        return relatedBasketLst;
    }

    public void setRelatedBasketLst(Object relatedBasketLst) {
