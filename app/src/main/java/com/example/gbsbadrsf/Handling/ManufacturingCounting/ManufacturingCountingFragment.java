...
//        viewModel = ViewModelProviders.of(this, providerFactory).get(ManufacturingCountingViewModel.class);
    ...
    private void observeSavingQty() {
        viewModel.getSaveManufacturingCount().observe(getViewLifecycleOwner(),response -> {
            ApiResponseSaveManufacturingProductionCounting apiResponseSaveManufacturingProductionCounting = (ApiResponseSaveManufacturingProductionCounting) response;
    ...
    private void observeBasketData() {
        viewModel.getBasketData().observe(getViewLifecycleOwner(),response -> {
            ApiResponseGetBasketInfo_ManufacturingProductionCounting apiResponseGetBasketInfo_manufacturingProductionCounting = (ApiResponseGetBasketInfo_ManufacturingProductionCounting) response;
            if (apiResponseGetBasketInfo_manufacturingProductionCounting!=null){
                ...
                if (apiResponseGetBasketInfo_manufacturingProductionCounting.getResponseStatus().getIsSuccess()){
                    ...
                    countingQty = apiResponseGetBasketInfo_manufacturingProductionCounting.getLastMoveManufacturingBasketInfo().getProductionCountingQty();
                    if (countingQty==0){
