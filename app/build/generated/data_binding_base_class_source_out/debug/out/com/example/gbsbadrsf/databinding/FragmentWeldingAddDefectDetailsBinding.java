...
public final class FragmentWeldingAddDefectDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentWeldingAddDefectDetailsBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentWeldingAddDefectDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentWeldingAddDefectDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_welding_add_defect_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWeldingAddDefectDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWeldingAddDefectDetailsBinding((ScrollView) rootView, addDefects, childesc,
          defectedQtyEdt, defectsListLayout, defectsSelectList, isRejected, binding_jobOrderData,
          listDownArrow, operation, sampleQtyEdt, title);
    }
