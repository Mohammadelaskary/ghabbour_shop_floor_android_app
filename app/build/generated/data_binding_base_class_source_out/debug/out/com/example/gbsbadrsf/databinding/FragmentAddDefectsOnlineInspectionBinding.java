...
public final class FragmentAddDefectsOnlineInspectionBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAddDefectsOnlineInspectionBinding(@NonNull ScrollView rootView,
      @NonNull MaterialButton addDefects, @NonNull TextView childParentDesc,
  ...
  @NonNull
  public static FragmentAddDefectsOnlineInspectionBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static FragmentAddDefectsOnlineInspectionBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.fragment_add_defects_online_inspection, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAddDefectsOnlineInspectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddDefectsOnlineInspectionBinding((ScrollView) rootView, addDefects,
          childParentDesc, defectedQtyEdt, defectsListLayout, defectsSelectList, isRejected,
