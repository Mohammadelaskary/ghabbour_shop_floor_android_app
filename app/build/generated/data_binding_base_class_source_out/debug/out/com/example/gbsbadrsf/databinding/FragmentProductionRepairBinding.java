...
public final class FragmentProductionRepairBinding implements ViewBinding {
  ...
  private FragmentProductionRepairBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextView defectnameTxt, @NonNull RecyclerView defectsDetailsList,
      @NonNull TextView defectsList, @NonNull TextView hint,
  ...
  public static FragmentProductionRepairBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProductionRepairBinding((ScrollView) rootView, addRepair, basketCode,
          binding_basketQtyLayout, childDesc, constraint, dataLayout, defectnameTxt,
          defectsDetailsList, defectsList, hint, binding_jobOrderData, operation,
