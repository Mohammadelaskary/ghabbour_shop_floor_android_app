...
public final class PaintAddBasketsLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private PaintAddBasketsLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static PaintAddBasketsLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PaintAddBasketsLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.paint_add_baskets_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PaintAddBasketsLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PaintAddBasketsLayoutBinding((ConstraintLayout) rootView, addDefecedBasket,
          addRejectedBasket, defectedQty, defectedText, loadingQtyTitle, qtyData, rejectedQty,
          rejectedText);
    }
