...
public final class FragmentPaintProductionRepairBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPaintProductionRepairBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentPaintProductionRepairBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPaintProductionRepairBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_paint_production_repair, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPaintProductionRepairBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaintProductionRepairBinding((ScrollView) rootView, addRepair, basketCode,
          binding_basketQtyLayout, constraint, dataLayout, defectnameTxt, defectsDetailsList,
          defectsList, hint, binding_jobOrderData, operation, parentDesc, productionRepairTxt,
          sampleqtyTxt);
    }
