...
public final class FragmentDisplayDefectDetailsBinding implements ViewBinding {
  ...
  private FragmentDisplayDefectDetailsBinding(@NonNull LinearLayout rootView,
      @NonNull TextView childesc, @NonNull TextInputLayout defectedQty,
      @NonNull LinearLayout defectsListLayout, @NonNull RecyclerView defectsSelectList,
      @NonNull JobOrderDataBinding jobOrderData, @NonNull ImageView listDownArrow,
      @NonNull TextView operation, @NonNull TextInputLayout sampleQty, @NonNull TextView title) {
  ...
  public static FragmentDisplayDefectDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDisplayDefectDetailsBinding((LinearLayout) rootView, childesc, defectedQty,
