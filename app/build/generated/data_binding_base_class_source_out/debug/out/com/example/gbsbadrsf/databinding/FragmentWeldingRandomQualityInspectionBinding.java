...
public final class FragmentWeldingRandomQualityInspectionBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentWeldingRandomQualityInspectionBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static FragmentWeldingRandomQualityInspectionBinding inflate(
  ...
  public static FragmentWeldingRandomQualityInspectionBinding inflate(
    ...
    View root = inflater.inflate(R.layout.fragment_welding_random_quality_inspection, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWeldingRandomQualityInspectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWeldingRandomQualityInspectionBinding((CoordinatorLayout) rootView,
          addDefects, childesc, dataLayout, binding_defectedRejectedBaskets, defectsPerQty,
          binding_jobOrderData, binding_loadingQtyData, binding_manufacturingDefectsPerQtyTitle,
          operation, randomQualityInspectionTxt, sampleQty, save, stationCode);
    }
