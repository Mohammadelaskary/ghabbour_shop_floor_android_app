...
public final class FragmentQualityDesicionBinding implements ViewBinding {
  ...
  private FragmentQualityDesicionBinding(@NonNull ScrollView rootView,
      ...
      @NonNull ConstraintLayout dataLayout, @NonNull DefectedQtyDataBinding defectedData,
  ...
  public static FragmentQualityDesicionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentQualityDesicionBinding((ScrollView) rootView, basketCode, checkListBtn,
          childesc, constraint, dataLayout, binding_defectedData, defectedQtnDefectsQtyRecycler,
          defectnameTxt, binding_jobOrderData, operation, qcdecisionXt, qfinaldesicionSpin,
