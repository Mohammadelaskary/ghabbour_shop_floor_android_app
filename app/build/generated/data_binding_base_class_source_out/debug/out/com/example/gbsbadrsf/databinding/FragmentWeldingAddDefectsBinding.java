...
public final class FragmentWeldingAddDefectsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentWeldingAddDefectsBinding(@NonNull ScrollView rootView,
      @NonNull TextInputLayout basketCode, @NonNull LinearLayout constraint,
      @NonNull ConstraintLayout dataLayout, @NonNull TextView defectedDetailsTxt,
      @NonNull TextInputLayout defectedQtyEdt, @NonNull TextView defectnameTxt,
      @NonNull RecyclerView defectsList, @NonNull JobOrderDataBinding jobOrderData,
      @NonNull TextView operation, @NonNull TextView parentDesc, @NonNull ImageView plusIcon,
      @NonNull TextInputLayout sampleQtyEdt, @NonNull TextView sampleqtyTxt,
      @NonNull LinearLayout tableTitle, @NonNull TextView titleTxt) {
  ...
  @NonNull
  public static FragmentWeldingAddDefectsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentWeldingAddDefectsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_welding_add_defects, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWeldingAddDefectsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWeldingAddDefectsBinding((ScrollView) rootView, basketCode, constraint,
          dataLayout, defectedDetailsTxt, defectedQtyEdt, defectnameTxt, defectsList,
          binding_jobOrderData, operation, parentDesc, plusIcon, sampleQtyEdt, sampleqtyTxt,
          tableTitle, titleTxt);
    }
