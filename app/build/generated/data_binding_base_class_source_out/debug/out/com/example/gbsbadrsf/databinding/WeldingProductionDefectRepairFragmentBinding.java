...
public final class WeldingProductionDefectRepairFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private WeldingProductionDefectRepairFragmentBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static WeldingProductionDefectRepairFragmentBinding inflate(
  ...
  public static WeldingProductionDefectRepairFragmentBinding inflate(
    ...
    View root = inflater.inflate(R.layout.welding_production_defect_repair_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WeldingProductionDefectRepairFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WeldingProductionDefectRepairFragmentBinding((ConstraintLayout) rootView,
          dataLayout, binding_defectedData, defectsDetailsList, operation, parentDesc,
          productionRepairTxt, repairedQty, saveBtn);
    }
