...
public final class FragmentPaintRejectionRequestDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPaintRejectionRequestDetailsBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static FragmentPaintRejectionRequestDetailsBinding inflate(
  ...
  public static FragmentPaintRejectionRequestDetailsBinding inflate(
    ...
    View root = inflater.inflate(R.layout.fragment_paint_rejection_request_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPaintRejectionRequestDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaintRejectionRequestDetailsBinding((CoordinatorLayout) rootView,
          acceptBtn, declineBtn, binding_defectsListBottomSheet, displayDefectBtn,
          binding_jobOrderData, notes, parentDesc, qualityscrapTxt, reason, reasonTxt,
          binding_rejectedQtyData, responsibledepTxt, responspileDep);
    }
