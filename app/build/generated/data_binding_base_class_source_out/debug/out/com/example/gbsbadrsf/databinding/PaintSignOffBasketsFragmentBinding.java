...
public final class PaintSignOffBasketsFragmentBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final PaintAddBasketsLayoutBinding signOffBaskets;

  @NonNull
  public final SignOffQtyBinding signOffData;

  private PaintSignOffBasketsFragmentBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull PaintAddBasketsLayoutBinding signOffBaskets,
  ...
  @NonNull
  public static PaintSignOffBasketsFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static PaintSignOffBasketsFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.paint_sign_off_baskets_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static PaintSignOffBasketsFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      PaintAddBasketsLayoutBinding binding_signOffBaskets = PaintAddBasketsLayoutBinding.bind(signOffBaskets);
      ...
      return new PaintSignOffBasketsFragmentBinding((CoordinatorLayout) rootView,
          binding_defectedRejectedBasketCodeBottomSheet, disableColor, binding_jobOrderData,
          operation, parentDesc, save, binding_signOffBaskets, binding_signOffData);
    }
