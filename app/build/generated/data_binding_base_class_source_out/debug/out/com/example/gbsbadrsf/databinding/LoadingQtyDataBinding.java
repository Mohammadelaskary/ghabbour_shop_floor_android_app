...
public final class LoadingQtyDataBinding implements ViewBinding {
  @NonNull
  ...
  private LoadingQtyDataBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static LoadingQtyDataBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LoadingQtyDataBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.loading_qty_data, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LoadingQtyDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LoadingQtyDataBinding((ConstraintLayout) rootView, loadingQtyTitle, qty, qtyData);
    }
