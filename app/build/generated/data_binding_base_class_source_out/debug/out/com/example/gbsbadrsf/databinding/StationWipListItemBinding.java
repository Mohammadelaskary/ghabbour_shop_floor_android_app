...
public final class StationWipListItemBinding implements ViewBinding {
  @NonNull
  ...
  private StationWipListItemBinding(@NonNull CardView rootView, @NonNull TextView childParentDesc,
  ...
  @NonNull
  public static StationWipListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static StationWipListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.station_wip_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static StationWipListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StationWipListItemBinding((CardView) rootView, childParentDesc, jobOrderName,
