...
public final class FragmentPaintDisplayDefectDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPaintDisplayDefectDetailsBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentPaintDisplayDefectDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPaintDisplayDefectDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_paint_display_defect_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPaintDisplayDefectDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaintDisplayDefectDetailsBinding((LinearLayout) rootView, defectedQty,
