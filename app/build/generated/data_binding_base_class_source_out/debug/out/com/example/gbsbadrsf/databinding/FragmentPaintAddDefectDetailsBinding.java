...
public final class FragmentPaintAddDefectDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPaintAddDefectDetailsBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentPaintAddDefectDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPaintAddDefectDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_paint_add_defect_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPaintAddDefectDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaintAddDefectDetailsBinding((ScrollView) rootView, addDefects, childesc,
