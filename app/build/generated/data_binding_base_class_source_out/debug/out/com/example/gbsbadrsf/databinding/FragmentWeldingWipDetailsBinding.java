...
public final class FragmentWeldingWipDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentWeldingWipDetailsBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextView stationDesc, @NonNull TextView textView11, @NonNull TextView textView12,
      @NonNull TextView textView15, @NonNull TextView textView4, @NonNull TextView textView9,
  ...
  @NonNull
  public static FragmentWeldingWipDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentWeldingWipDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_welding_wip__details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWeldingWipDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.station_desc;
      TextView stationDesc = ViewBindings.findChildViewById(rootView, id);
      if (stationDesc == null) {
        break missingId;
      }
      ...
      return new FragmentWeldingWipDetailsBinding((ScrollView) rootView, expectedTime, jobOrderData,
          jobOrderQty, jobordernum, jobordernumTxt, loadingQty, machineDieData, operationData,
          operationName, operationQty, operationTime, operationTitleTxt, parentDesc, remainingTime,
          signInTime, stationDesc, textView11, textView12, textView15, textView4, textView9,
          timeData, timeTitleTxt);
    }
