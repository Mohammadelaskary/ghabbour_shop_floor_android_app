...
public final class FragmentQualityDefectRepairBinding implements ViewBinding {
  ...
  private FragmentQualityDefectRepairBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull TextView moveToBasketQty, @NonNull NestedScrollView nestedScrollView2,
      @NonNull TextView operation, @NonNull TextView parentDesc, @NonNull TextView qualityRepairTxt,
  ...
  public static FragmentQualityDefectRepairBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentQualityDefectRepairBinding((CoordinatorLayout) rootView, approvedQty,
          dataLayout, binding_defectedData, defectsDetailsList, disable, moveToBasket,
          binding_moveToBasketBottomSheet, moveToBasketQty, nestedScrollView2, operation,
          parentDesc, qualityRepairTxt, reopenDefectBtn, saveBtn);
    }
