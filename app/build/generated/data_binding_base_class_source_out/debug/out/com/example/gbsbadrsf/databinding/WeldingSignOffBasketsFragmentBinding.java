...
public final class WeldingSignOffBasketsFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private WeldingSignOffBasketsFragmentBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static WeldingSignOffBasketsFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WeldingSignOffBasketsFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.welding_sign_off_baskets_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WeldingSignOffBasketsFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WeldingSignOffBasketsFragmentBinding((CoordinatorLayout) rootView,
