...
public final class QualityOkBasketsBottomSheetBinding implements ViewBinding {
  @NonNull
  ...
  private QualityOkBasketsBottomSheetBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static QualityOkBasketsBottomSheetBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static QualityOkBasketsBottomSheetBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.quality_ok_baskets_bottom_sheet, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static QualityOkBasketsBottomSheetBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new QualityOkBasketsBottomSheetBinding((ScrollView) rootView, basketQty, basketQtyTxt,
          basketcodeEdt, basketcodeRv, bulk, bulkGroup, cancel, childdesc, diff, dragIcon,
          newbasketcodeEdt, saveBtn, tableTitle, totalAddedQtn, totalqtnTxt);
    }
