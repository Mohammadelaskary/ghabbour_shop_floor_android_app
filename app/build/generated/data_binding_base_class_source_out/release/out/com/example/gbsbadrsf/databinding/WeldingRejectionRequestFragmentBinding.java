...
public final class WeldingRejectionRequestFragmentBinding implements ViewBinding {
  @NonNull
  ...
  private WeldingRejectionRequestFragmentBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull TextInputLayout oldBasketCode, @NonNull TextView operation,
      @NonNull TextView parentDesc, @NonNull TextView productionscrapTxt,
  ...
  @NonNull
  public static WeldingRejectionRequestFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WeldingRejectionRequestFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.welding_rejection_request_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WeldingRejectionRequestFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WeldingRejectionRequestFragmentBinding((CoordinatorLayout) rootView, dataLayout,
          binding_defectsListBottomSheet, disableColor, binding_jobOrderData,
          binding_loadingQtyData, newBasketCode, newdefBtn, oldBasketCode, operation, parentDesc,
