...
public final class FragmentSignoffweBinding implements ViewBinding {
  ...
  @NonNull
  public final TextInputLayout stationEdt;

  @NonNull
  public final TextInputEditText stationNewedt;
  ...
  private FragmentSignoffweBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull TextView signoffqtnTxt, @NonNull TextInputLayout stationEdt,
      @NonNull TextInputEditText stationNewedt, @NonNull TextView textView1,
    ...
    this.stationNewedt = stationNewedt;
  ...
  public static FragmentSignoffweBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.station_edt;
      TextInputLayout stationEdt = ViewBindings.findChildViewById(rootView, id);
      if (stationEdt == null) {
        break missingId;
      }

      id = R.id.station_newedt;
      TextInputEditText stationNewedt = ViewBindings.findChildViewById(rootView, id);
      if (stationNewedt == null) {
        break missingId;
      }
      ...
      return new FragmentSignoffweBinding((CoordinatorLayout) rootView, Joborderqtn,
          binding_basketsBottomSheet, dataLayout, jobOrderData, jobordernum, jobordernumTxt,
          loadingQty, operationname, parentDesc, saveBtn, signOffData, signOffQty, signOffQtyTxt,
          signedOffQty, signoffitemsBtn, signoffqtnTxt, stationEdt, stationNewedt, textView1,
          textView20);
    }
