...
public final class FragmentManufacturingAddDefectDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentManufacturingAddDefectDetailsBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentManufacturingAddDefectDetailsBinding inflate(
  ...
  public static FragmentManufacturingAddDefectDetailsBinding inflate(
    ...
    View root = inflater.inflate(R.layout.fragment_manufacturing_add_defect_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentManufacturingAddDefectDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentManufacturingAddDefectDetailsBinding((ScrollView) rootView, addDefects,
          childesc, defectedQtyEdt, defectsListLayout, defectsSelectList, isRejected,
