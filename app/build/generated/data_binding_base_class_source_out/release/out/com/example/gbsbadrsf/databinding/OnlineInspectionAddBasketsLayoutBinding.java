...
public final class OnlineInspectionAddBasketsLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private OnlineInspectionAddBasketsLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static OnlineInspectionAddBasketsLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static OnlineInspectionAddBasketsLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.online_inspection_add_baskets_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static OnlineInspectionAddBasketsLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new OnlineInspectionAddBasketsLayoutBinding((ConstraintLayout) rootView,
