...
public final class ProductionSequenceItemBinding implements ViewBinding {
  @NonNull
  ...
  private ProductionSequenceItemBinding(@NonNull LinearLayout rootView, @NonNull TextView childTxt,
      @NonNull TextView jobOrderQty, @NonNull TextView joborderqtnTxt, @NonNull LinearLayout myView,
      @NonNull TextView parentDesc, @NonNull TextView remainingQty, @NonNull TextView sequenceNum) {
  ...
  @NonNull
  public static ProductionSequenceItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ProductionSequenceItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.production_sequence_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ProductionSequenceItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProductionSequenceItemBinding((LinearLayout) rootView, childTxt, jobOrderQty,
          joborderqtnTxt, myView, parentDesc, remainingQty, sequenceNum);
    }
