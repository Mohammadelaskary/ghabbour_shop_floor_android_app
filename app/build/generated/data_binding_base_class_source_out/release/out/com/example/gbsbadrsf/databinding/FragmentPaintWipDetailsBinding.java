...
public final class FragmentPaintWipDetailsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPaintWipDetailsBinding(@NonNull ScrollView rootView,
  ...
  @NonNull
  public static FragmentPaintWipDetailsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPaintWipDetailsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_paint_wip_details, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPaintWipDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPaintWipDetailsBinding((ScrollView) rootView, expectedTime, jobOrderData,
