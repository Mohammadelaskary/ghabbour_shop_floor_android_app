...
public final class FragmentWeldingQualityOperationBinding implements ViewBinding {
  ...
  private FragmentWeldingQualityOperationBinding(@NonNull ScrollView rootView,
      @NonNull MaterialButton addDefects, @NonNull TextView adddefectTxt,
      @NonNull TextInputLayout basketCode, @NonNull ConstraintLayout dataLayout,
      @NonNull TextInputLayout defecedQty, @NonNull ConstraintLayout defectsListLayout,
      @NonNull RecyclerView defectsPerQty, @NonNull SwitchMaterial fullInspectionSwitch,
      @NonNull JobOrderDataBinding jobOrderData, @NonNull NestedScrollView layout,
  ...
  public static FragmentWeldingQualityOperationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWeldingQualityOperationBinding((ScrollView) rootView, addDefects,
          adddefectTxt, basketCode, dataLayout, defecedQty, defectsListLayout, defectsPerQty,
          ...
          qualityOk, qualityPass, rejectedQty, relatedBaskets, sampleQtnEdt, signOffBaskets,
          binding_signOffData);
    }
